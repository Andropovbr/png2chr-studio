const en = {
  ...
  chrWorkspaceHighlightScopeFrame: 'Current Frame ({info})',
  chrWorkspaceHighlightScopeAnimation: 'Current Animation ({name})',
  chrWorkspaceHighlightScopeEntity: 'Current Entity ({name})',
...
const ptBr = {
  ...
  chrWorkspaceHighlightScopeFrame: 'Frame Atual ({info})',
  chrWorkspaceHighlightScopeAnimation: 'Animação Atual ({name})',
  chrWorkspaceHighlightScopeEntity: 'Entidade Atual ({name})',
