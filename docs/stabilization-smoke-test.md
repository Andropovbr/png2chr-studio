...
| 10   | Save project as `.p2c`, reload the application, and open the saved file.                                                                      | Project state reloads completely; exports re-generated from reloaded model are 100% bit-for-bit identical to initial exports.                                                            |
