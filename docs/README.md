...
| [**Arquitetura Gráfica do Projeto**](./project-graphics-architecture.md)                                  | Modelo canônico de assets gráficos, Base CHR, contextos de renderização, perfil NROM e migração de projetos v1 para v2.                                                            |
| [**Compilador Gráfico do Projeto**](./project-graphics-compiler.md)                                       | Compilação CHR project-wide determinística, manifesto imutável, invariantes de Pattern Table e falhas atômicas.                                                                    |
